...
function calcularCustoTotal(salario, salarioPorFora = 0, temValeAlimentacao = false, hasPatronal = true, hasContTerceiros = true) {
...
console.log(`Esperado: R$ 1618.24, Resultado: ${custo1 === 1618.24 ? '✓ CORRETO' : '✗ INCORRETO'}\n`);
...
console.log(`Esperado: R$ 3236.48, Resultado: ${custo2 === 3236.48 ? '✓ CORRETO' : '✗ INCORRETO'}\n`);
...
console.log(`Esperado: R$ 1878.24, Resultado: ${custo3 === 1878.24 ? '✓ CORRETO' : '✗ INCORRETO'}\n`);
...
console.log(`Esperado: R$ 2118.24, Resultado: ${custo4 === 2118.24 ? '✓ CORRETO' : '✗ INCORRETO'}\n`);
...
console.log(`Esperado: R$ 2378.24, Resultado: ${custo5 === 2378.24 ? '✓ CORRETO' : '✗ INCORRETO'}\n`);

// Test 6: Salário R$ 1500
const custo6 = calcularCustoTotal(1500);
console.log(`Salário R$ 1500,00: Custo Total = R$ ${custo6}`);
console.log(`Esperado: R$ 2427.37, Resultado: ${custo6 === 2427.37 ? '✓ CORRETO' : '✗ INCORRETO'}\n`);

// Test 7: Salário R$ 6020 + R$ 3100 por fora (sem patronal/cont terceiros)
const custo7 = calcularCustoTotal(6020, 3100, false, false, false);
console.log(`Salário R$ 6020,00 + R$ 3100 por fora (sem patronal/cont terceiros): Custo Total = R$ ${custo7}`);
console.log(`Esperado: R$ 10900.00, Resultado: ${custo7 === 10900.00 ? '✓ CORRETO' : '✗ INCORRETO'}\n`);
