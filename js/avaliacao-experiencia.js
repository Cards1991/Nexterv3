...
function imprimirAvaliacaoExperiencia(dados, nome, setor, gerenteSetor = '_________________________') {
    ...
    const conteudo = `
        ...
        <body>
            <div class="header">
                <h3>AVALIAÃƒâ€¡ÃƒÆ’O DE CONTRATO DE EXPERIÃƒÅ NCIA</h3>
...
// --- HISTÃƒâ€œRICO DE AVALIAÃƒâ€¡Ãƒâ€¢ES ---
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-primary text-white">
                        <h5 class="modal-title"><i class="fas fa-balance-scale"></i> Antecedentes no Escavador</h5>
