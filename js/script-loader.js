...
const ScriptLoader = {
    ...
    sectionScripts: {
        ...
        'funcionarios': ['js/funcionarios.js?v=21'],
        ...
        'iso-manutencao': ['js/iso-manutencao.js?v=3'],
        ...
        'gestao-documentos': ['js/gestao-documentos.js'],
        'iso-avaliacao-colaboradores': ['js/iso-avaliacao-colaboradores.js'],
        'gerenciar-avaliacoes': ['js/iso-avaliacao-colaboradores.js'],
        'iso-auditorias': ['js/iso-auditorias.js'],
        'iso-indicadores': ['js/iso-escopo-dinamico.js'],
        'iso-evidencias': ['js/iso-escopo-dinamico.js'],
        ...
        'admin-config-iso': ['js/admin-config-iso.js'],
