...
async function salvarEntregaEPI() {
    ...
    try {
        ...
        imprimirRelatorioEntrega(entregaId, funcionarioNome, dataEntrega, responsavel, itensEntregaAtual);
...
function imprimirRelatorioEntrega(id, funcionario, data, responsavel, itens) {
